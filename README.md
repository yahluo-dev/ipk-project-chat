...
There are unit tests as well as "smoke tests" are available in the *tests/* subdirectory. The command **make test** will run the smoke tests, and **make unit-test** will run the unit tests.
